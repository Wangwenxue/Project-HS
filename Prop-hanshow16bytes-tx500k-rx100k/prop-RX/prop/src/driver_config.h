...
#define CONFIG_DMA_DEFAULT_IRQHANDLER                   FALSE        /*!< Enable/Disable DMA Default IRQ Handler */
#define CONFIG_DMA_ENABLE_INTERRUPT                     FALSE        /*!< Enable/Disable DMA Interrupt */
...
#define CONFIG_ENABLE_DRIVER_PROP                       TRUE        /*!< Enable/Disable Proprietary Driver */
